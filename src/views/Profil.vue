...
<template>
  <div class="h-full flex flex-col">
    ...
    <div class="flex-1">
      ...
      <!-- Admin Links / Feedback Button (Mobile/Secondary) -->
      <div class="mt-8 px-2 space-y-4 md:hidden">
        ...
        <template v-if="userRole === 'user'">
          <button @click="showModalMasukan = true" class="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-serenity-600 bg-serenity-50 hover:bg-serenity-100 rounded-xl transition-colors shadow-sm">
