    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div class="mt-4 flex justify-end items-center gap-4">
          <button v-if="item.status === 'baru'" @click="tandaiDibaca(item.id)" class="text-xs font-semibold text-serenity-600 hover:text-serenity-800 flex items-center gap-1">
          ...
          <button @click="hapusMasukan(item.id)" class="text-xs font-semibold text-red-500 hover:text-red-700 flex items-center gap-1 transition-colors">
