...
async function handleSubmit() {
  ...
  successMsg.value = 'Akun berhasil dibuat! Mengarahkan...'
    ...
    <div class="auth-panel">
      ...
      <form class="auth-form" @submit.prevent="handleSubmit">
        ...
        <div class="auth-input-group">
          <svg xmlns="http://www.w3.org/2000/svg" class="auth-input-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
          <input v-model="namaKeluarga" type="text" required placeholder="Nama Keluarga (misal: Keluarga Budi)" class="auth-input" />
        </div>
        ...
        <div class="auth-input-group">
          ...
          <input v-model="password" :type="showPassword ? 'text' : 'password'" required minlength="6" placeholder="Minimal 6 karakter" class="auth-input" />
      ...
      <p class="auth-switch">
        Sudah punya akun?
        <RouterLink to="/masuk" class="auth-switch-link">Masuk di sini</RouterLink>
      </p>
    </div>
  </div>
</template>
