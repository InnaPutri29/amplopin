...
.glass-datepicker .dp__arrow_top {
  display: none;
}

.glass-datepicker .dp__inner_nav {
  border-radius: 0.75rem;
}

.glass-datepicker .dp__inner_nav:hover {
  background: rgba(134, 158, 201, 0.2);
}

.glass-datepicker .dp__calendar_header_item {
  font-weight: 600;
  color: #64748b;
  text-transform: capitalize;
}

.glass-datepicker .dp__cell_inner {
  border-radius: 0.75rem;
  transition: all 0.2s;
}

.glass-datepicker .dp__today {
